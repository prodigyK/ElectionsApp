    ...
    <div class="ui tiny form padded blue secondary segment tiny" style="margin-left: 120px; margin-right: 120px;">
        ...
        <div class="inline field">
            <div class="ui toggle checkbox">
                <input path="storonnik" class="form-control font-weight-bold" type="checkbox" tabindex="0"
                       id="type_storonnik"/>
        ...
        <br>
        <button class="ui right floated button small" onclick="savePerson()" id="save_button">
